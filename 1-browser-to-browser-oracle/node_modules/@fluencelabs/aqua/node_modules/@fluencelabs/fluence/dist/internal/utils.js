...
exports.throwIfNotSupported = exports.jsonify = exports.dataToString = exports.checkConnection = exports.doNothing = exports.handleTimeout = exports.MakeServiceCall = void 0;
        ...
        switch (_a.label) {
            case 0:
                ...
                promise = new Promise(function (resolve, reject) {
                    ...
                    var particle = Particle_1.Particle.createNew(script, ttl);
...
function throwIfNotSupported() {
    if (platform_1.default.name === 'Node.js') {
