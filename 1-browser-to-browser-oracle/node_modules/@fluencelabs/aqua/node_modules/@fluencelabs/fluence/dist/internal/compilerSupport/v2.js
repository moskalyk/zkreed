...
function callFunction(rawFnArgs, def, script) {
    ...
    var promise = new Promise(function (resolve, reject) {
        var particle = Particle_1.Particle.createNew(script, config === null || config === void 0 ? void 0 : config.ttl);
        ...
        peer.internals.initiateParticle(particle, function (stage) {
            ...
            if (stage.stage === 'interpreterError') {
                reject("Script interpretation failed for " + def.functionName + ": " + stage.errorMessage + "  (particle id: " + particle.id + ")");
            }
        });
    });
    return promise;
...
function registerService(args, def) {
    ...
    if (!!incorrectServiceDefinitions.length) {
        throw new Error("Error registering service " + serviceId + ": missing functions: " +
