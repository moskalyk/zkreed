...
exports.builtInServices = {
    ...
    srv: {
        ...
        get_interface: function (req) {
            return errorNotImpl('srv.get_interface');
        },
        resolve_alias: function (req) {
            return errorNotImpl('srv.resolve_alias');
        },
        add_alias: function (req) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [2 /*return*/, error('sha256_string accepts 1-3 arguments, found: ' + req.args.length)];
                    case 1:
