...
var FluencePeer = /** @class */ (function () {
    ...
    FluencePeer.prototype.getStatus = function () {
        var _a, _b;
        var hasKeyPair = this._keyPair !== undefined;
        return {
            // TODO:: use explicit mechanism for peer's state
            isInitialized: hasKeyPair,
            isConnected: this._connection !== undefined,
            peerId: ((_b = (_a = this._keyPair) === null || _a === void 0 ? void 0 : _a.Libp2pPeerId) === null || _b === void 0 ? void 0 : _b.toB58String()) || null,
    ...
    FluencePeer.prototype.start = function (config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var _d, marineDeps, _e, connectToMultiAddr, fromNode, _f;
            var _this = this;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        (0, utils_1.throwIfNotSupported)();
                        if (!(config === null || config === void 0 ? void 0 : config.KeyPair)) return [3 /*break*/, 1];
                    ...
                    case 3:
                        ...
                        this._defaultTTL =
                            (config === null || config === void 0 ? void 0 : config.defaultTtlMs) !== undefined // don't miss value 0 (zero)
                                ? config === null || config === void 0 ? void 0 : config.defaultTtlMs
                                : DEFAULT_TTL;
                        if ((_b = config === null || config === void 0 ? void 0 : config.debug) === null || _b === void 0 ? void 0 : _b.marineLogLevel) {
                            this._marineLogLevel = config.debug.marineLogLevel;
                        }
                        this._fluenceAppService = new marine_js_1.FluenceAppService((_c = config === null || config === void 0 ? void 0 : config.marineJS) === null || _c === void 0 ? void 0 : _c.workerScriptPath);
                        if (!(config === null || config === void 0 ? void 0 : config.marineJS)) return [3 /*break*/, 5];
                        return [4 /*yield*/, loadMarineAndAvm(config.marineJS.marineWasmPath, config.marineJS.avmWasmPath)];
                    case 4:
                        _e = _g.sent();
                        return [3 /*break*/, 7];
                    case 5: return [4 /*yield*/, (0, marine_js_1.loadDefaults)()];
                    case 6:
                        _e = _g.sent();
                        _g.label = 7;
                    case 7:
                    ...
                    case 8:
                        _g.sent();
                        return [4 /*yield*/, this._fluenceAppService.createService(marineDeps.avm, 'avm')];
                    case 9:
                        _g.sent();
                        this._avmRunner = (config === null || config === void 0 ? void 0 : config.avmRunner) || new avm_1.AVM(this._fluenceAppService);
                        return [4 /*yield*/, this._avmRunner.init((config === null || config === void 0 ? void 0 : config.avmLogLevel) || 'off')];
                    case 10:
                        _g.sent();
                        if (!(config === null || config === void 0 ? void 0 : config.connectTo)) return [3 /*break*/, 15];
                        ...
                        if (!this._connection) return [3 /*break*/, 12];
                    ...
                    case 12:
                        _f = this;
                        return [4 /*yield*/, FluenceConnection_1.FluenceConnection.createConnection({
                                peerId: this._keyPair.Libp2pPeerId,
                                relayAddress: connectToMultiAddr,
                                dialTimeoutMs: config.dialTimeoutMs,
                                onIncomingParticle: function (p) { return _this._incomingParticles.next({ particle: p, onStageChange: function () { } }); },
                            })];
                    case 13:
                        _f._connection = _g.sent();
                    ...
                    case 15:
                        ...
                        this._classServices.sig.securityGuard = (0, Sig_1.defaultSigGuard)(this.getStatus().peerId);
                        (0, services_1.registerSig)(this, this._classServices.sig);
                        (0, services_1.registerSig)(this, this.getStatus().peerId, this._classServices.sig);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        envs = this._marineLogLevel ? { WASM_LOG: this._marineLogLevel } : undefined;
                        return [4 /*yield*/, this._fluenceAppService.createService(wasm, serviceId, undefined, envs)];
                    case 1:
                        _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        _c.sent();
                        return [4 /*yield*/, ((_a = this._avmRunner) === null || _a === void 0 ? void 0 : _a.terminate())];
                    case 2:
                        _c.sent();
                        return [4 /*yield*/, ((_b = this._fluenceAppService) === null || _b === void 0 ? void 0 : _b.terminate())];
                    case 3:
                        _c.sent();
            ...
            return {
                ...
                initiateParticle: function (particle, onStageChange) {
                    ...
                    if (particle.initPeerId === undefined) {
                        particle.initPeerId = _this.getStatus().peerId;
                    }
    ...
    FluencePeer.prototype._connect = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [2 /*return*/, (_a = this._connection) === null || _a === void 0 ? void 0 : _a.connect()];
            });
        });
    };
    // TODO:: make public when full connection\disconnection cycle is implemented properly
    ...
    FluencePeer.prototype._startParticleProcessing = function () {
        ...
        this._outgoingParticles.subscribe(function (item) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._connection.sendParticle(item.particle)];
                    case 1:
                        _a.sent();
    ...
    FluencePeer.prototype._expireParticle = function (item) {
        ...
        loglevel_1.default.debug("particle " + particleId + " has expired after " + item.particle.ttl + ". Deleting particle-related queues and handlers");
    ...
    FluencePeer.prototype._createParticlesProcessingQueue = function () {
        ...
        particlesQueue
            .pipe(
        // force new line
        filterExpiredParticles(this._expireParticle.bind(this)), (0, rxjs_1.concatMap)(function (item) { return __awaiter(_this, void 0, void 0, function () {
            var result, newData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, runAvmRunner(this.getStatus().peerId, this._avmRunner, item.particle, prevData)];
                    case 1:
                        result = _a.sent();
                        newData = Buffer_1.default.from(result.data);
                        prevData = newData;
                        return [2 /*return*/, __assign(__assign({}, item), { result: result, newData: newData })];
                }
            });
        }); }))
            .subscribe(function (item) { return __awaiter(_this, void 0, void 0, function () {
            var newParticle, _loop_1, this_1, _a, _b, _c, key, cr;
            var e_1, _d;
            return __generator(this, function (_e) {
                ...
                if (item.result.nextPeerPks.length > 0) {
                    newParticle = item.particle.clone();
                    newParticle.data = item.newData;
                    this._outgoingParticles.next(__assign(__assign({}, item), { particle: newParticle }));
                }
                // execute call requests if needed
                // and put particle with the results back to queue
                if (item.result.callRequests.length > 0) {
                    _loop_1 = function (key, cr) {
                        var req = {
                        ...
                        this_1._execSingleCallRequest(req)
                    ...
                    this_1 = this;
                    try {
                        for (_a = __values(item.result.callRequests), _b = _a.next(); !_b.done; _b = _a.next()) {
                            _c = __read(_b.value, 2), key = _c[0], cr = _c[1];
                            _loop_1(key, cr);
                        }
                    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!this._marineServices.has(req.serviceId)) return [3 /*break*/, 2];
                        args = JSON.stringify(req.args);
                        return [4 /*yield*/, this._fluenceAppService.callService(req.serviceId, req.fnName, args, undefined)];
                    case 1:
                        rawResult = _a.sent();
                        try {
                            ...
                            if (result.result === undefined) {
                                throw 'Call to marine-js returned no error and empty result. Original request: ' + (0, utils_1.jsonify)(req);
                            }
                            return [2 /*return*/, {
                    ...
                    case 2:
                        ...
                        if (handler === undefined) {
                            return [2 /*return*/, {
                                    retCode: commonTypes_1.ResultCodes.error,
                                    result: "No handler has been registered for serviceId='" + req.serviceId + "' fnName='" + req.fnName + "' args='" + (0, utils_1.jsonify)(req.args) + "'",
                                }];
                        }
    ...
    FluencePeer.prototype._stopParticleProcessing = function () {
        ...
        try {
            ...
            for (var _b = __values(this._timeouts), _c = _b.next(); !_c.done; _c = _b.next()) {
                var item = _c.value;
                clearTimeout(item);
            }
        }
...
function registerDefaultServices(peer) {
    for (var serviceId in common_1.builtInServices) {
        for (var fnName in common_1.builtInServices[serviceId]) {
            var h = common_1.builtInServices[serviceId][fnName];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, runner.run(particle.script, prevData, particle.data, {
                ...
                case 1:
                    ...
                    toLog = __assign({}, interpreterResult);
                    toLog.data = (0, utils_1.dataToString)(toLog.data);
                    ...
                    return [2 /*return*/, interpreterResult];
            }
        });
    });
}
