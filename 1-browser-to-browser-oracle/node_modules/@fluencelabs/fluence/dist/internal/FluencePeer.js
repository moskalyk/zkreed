            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0:
                        ...
                        if (!((_a = config === null || config === void 0 ? void 0 : config.KeyPair) !== null && _a !== void 0)) return [3 /*break*/, 1];
                        _f = _a;
                        return [3 /*break*/, 3];
    ...
    FluencePeer.prototype._createParticlesProcessingQueue = function () {
        ...
        particlesQueue
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, runAvmRunner(status.peerId, this._avmRunner, item.particle, prevData)];
                    case 1:
                        result = _a.sent();
            ...
            if (item.result.nextPeerPks.length > 0) {
                ...
                _this._outgoingParticles.next(__assign(__assign({}, item), { particle: newParticle }));
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    toLog = __assign(__assign({}, interpreterResult), { data: (0, utils_1.dataToString)(interpreterResult.data) });
